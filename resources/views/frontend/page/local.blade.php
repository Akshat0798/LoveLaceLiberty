    ...
    <div class="sidebar">
        ...
        <div class="sidelinks p-3">
            <ul class="list-unstyled mb-0 h-100 d-flex d-md-none">
                ...
                <li>
                    <a class="active" href="localRepresentatives.html">LocalRepresentatives</a>
                </li>
                <li>
            ...
            <ul class="list-unstyled mb-0 h-100 d-none d-md-flex">
                ...
                <li>
                    <a class="active" href="{{route('client.localView',$value)}}">LocalRepresentatives</a>
                </li>
                    ...
                    <div class="accordion" id="accordionSidebar">
                        <div class="accordion-item bg-transparent">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body px-0">
                                    <ul class="list-group">
                                        <li class="list-group-item"> Mayor Name</li>
                                        <li class="list-group-item">  Mayor Pro Tem</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-power"><path d="M18.36 6.64a9 9 0 1 1-12.73 0"></path><line x1="12" y1="2" x2="12" y2="12"></line></svg></span>Sign Out
        ...
        <div class="main h-100 overflow-auto">
            <div class="container my-4">
                    <h4 class="text-center pageTitle mb-3">Local Representatives for <span class="themeColor">City</span></h4>
                  
                   
                        <div class="row g-3 mt-3 justify-content-center"> <!-- Use g-2 for small gutters -->
                            <!-- Box 1: Image, Follow, Elections -->
                            <div class="col-md-4">
                                <div class="mfacard w-100 p-3 h-100">
                                    <div class="card-body text-center">
                                        <img src="{{ asset('assetss/images/user.svg')}}" alt="Abraham Lincoln" class="img-fluid rounded-circle mb-3"
                                            style="width: 150px;">
