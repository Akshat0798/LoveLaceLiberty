...
<div class="container-fluid">      
    <div class="page-inner">          
        <h4 class="page-title">Page Content {{ trans('admin_lang.manage') }}</h4>
        @if (session('success'))
                ...
                {{-- <div class="card-header">
                        ...
                        <div class="d-flex align-items-center float-right">
                            <a href="{{routeUser($pagePath.'.create')}}" >
                                ...
                                <i class="fas fa-plus"></i> &nbsp; {{  trans('admin_lang.add')}} Content </button>
                            </a>
                        </div>
                    </div>   --}}
                    <div class="card-body">
                            ...
                            <table id="basic-datatables" class="display table table-striped table-hover show">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans("admin_lang.description") }}</th>
                                        {{-- <th>{{ trans("admin_lang.created") }}</th> --}}
