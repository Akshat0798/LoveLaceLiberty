...
<div class="container-fluid">      
    <div class="page-inner">          
        <h4 class="page-title">{{ trans('admin_lang.city') }} {{ trans('admin_lang.manage') }}</h4>
        @if (session('success'))
                ...
                <div class="card-header">
                        ...
                        <div class="d-flex align-items-center float-right">
                            <a href="{{routeUser($pagePath.'.create')}}">
                                ...
                                <i class="fas fa-plus"></i> &nbsp; {{  trans('admin_lang.add').' '.Illuminate\Support\Str::singular(trans('admin_lang.city')) }}</button>
                            </a>
                        </div>
                    </div>  
                            ...
                            <table id="basic-datatables" class="display table table-striped table-hover show">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ trans("admin_lang.city") }} {{ trans("admin_lang.name") }}</th>
