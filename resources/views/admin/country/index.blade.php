...
<div class="container-fluid">      
    <div class="page-inner">          
        <h4 class="page-title">{{ trans('admin_lang.country') }} {{ trans('admin_lang.manage') }}</h4>
        @if (session('success'))
                ...
                <div class="card-header">
                        ...
                        <div class="d-flex align-items-center float-right">
                            <a href="{{routeUser($pagePath.'.create')}}">
                                ...
                                <i class="fas fa-plus"></i> &nbsp; {{  trans('admin_lang.add').' '.Illuminate\Support\Str::singular(trans('admin_lang.country')) }}</button>
                            </a>
                        </div>
                    </div>  
                    <div class="card-body">
