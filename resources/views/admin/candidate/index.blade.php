...
<div class="container-fluid">      
    <div class="page-inner">          
        <h4 class="page-title">Candidate {{ trans('admin_lang.manage') }}</h4>
        @if (session('success'))
                ...
                <div class="card-header">
                        <div class="d-flex align-items-center float-right">
                            ...
                            <a href="{{routeUser($pagePath.'.create')}}" >
                                ...
                                <i class="fas fa-plus"></i> &nbsp; {{  trans('admin_lang.add')}} Candidate </button>
                            </a>
                        </div>
                    </div>  
                    <div class="card-body">
                ...
                <table id="basic-datatables" class="table table-bordered show" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="action">{{ trans("admin_lang.description") }}</th>
...
$(document).ready(function () {
    ...
    var tables = $('#basic-datatables').DataTable({
        ...
        "order": [[0, "desc"]],
        "ajax": {
            url: "{{ routeUser('candidate.index',['type'=>$typePath]) }}",
            error: function () {
